...
class BilinearFusion(nn.Module):
    ...
    def __init__(self, skip=1, use_bilinear=1, gate1=1, gate2=1, dim1=32, dim2=32, scale_dim1=1, scale_dim2=1, mmhid=64,
                 dropout_rate=0.25):
...
class TrilinearFusionB(nn.Module):
    def __init__(self, skip=1, use_bilinear=1, gate1=1, gate2=1, gate3=1, dim1=32, dim2=32, dim3=32, scale_dim1=1,
        ...
        super(TrilinearFusionB, self).__init__()
        self.skip = skip
        self.use_bilinear = use_bilinear
        self.gate1 = gate1
        self.gate2 = gate2
        ...
        dim1_og, dim2_og, dim3_og, dim1, dim2, dim3 = dim1, dim2, dim3, dim1 // scale_dim1, \
            dim2 // scale_dim2, dim3 // scale_dim3
...
class QualinearFusion(nn.Module):
    def __init__(self, skip=1, use_bilinear=1,
        ...
        dim1_og, dim2_og, dim3_og, dim4_og, dim1, dim2, dim3, dim4 = dim1, dim2, dim3, dim4, dim1 // scale_dim1, \
            dim2 // scale_dim2, dim3 // scale_dim3, dim4 // scale_dim4
        # skip_dim = dim1 + dim2 + dim3 + 3 if skip else 0
